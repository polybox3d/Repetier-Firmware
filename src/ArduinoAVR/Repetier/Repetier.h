...
#define BED_1_ANALOG_CHANNEL KOMMA0 HEATER_BED_0_SENSOR
#define KOMMA1 ,
#else
...
#define BED_2_ANALOG_CHANNEL KOMMA1 HEATER_BED_0_SENSOR
#define KOMMA2 ,
#else
...
#define BED_3_ANALOG_CHANNEL KOMMA2 HEATER_BED_0_SENSOR
#define KOMMA3 ,
#else
...
#define ANALOG_INPUTS (EXT0_ANALOG_INPUTS+EXT1_ANALOG_INPUTS+EXT2_ANALOG_INPUTS+EXT3_ANALOG_INPUTS+EXT4_ANALOG_INPUTS+EXT5_ANALOG_INPUTS+BED_0_ANALOG_INPUTS+BED_1_ANALOG_INPUTS+BED_2_ANALOG_INPUTS+BED_3_ANALOG_INPUTS)
#if ANALOG_INPUTS>0
/** Channels are the MUX-part of ADMUX register */
#define  ANALOG_INPUT_CHANNELS {EXT0_ANALOG_CHANNEL EXT1_ANALOG_CHANNEL EXT2_ANALOG_CHANNEL EXT3_ANALOG_CHANNEL EXT4_ANALOG_CHANNEL EXT5_ANALOG_CHANNEL BED_0_ANALOG_CHANNEL BED_1_ANALOG_CHANNEL BED_2_ANALOG_CHANNEL BED_3_ANALOG_CHANNEL}
#endif
...
extern uint8_t pwm_pos[NUM_EXTRUDER+15];//increase size of tab. uint_8 is nothing and dynamic var + static (3) as defautl value is kinda weird, especially since user can not use the +3 (cause it's fan) // 0-NUM_EXTRUDER = Heater 0-NUM_EXTRUDER of extruder, NUM_EXTRUDER = Heated bed, NUM_EXTRUDER+1 Board fan, NUM_EXTRUDER+2 = Fan
#ifdef USE_ADVANCE
