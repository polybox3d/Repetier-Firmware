...
#define LVM_FACE_1_R				(10+PINS_PER_BOARD*ID_BOARD_RGB)
#define LVM_FACE_1_G				(9+PINS_PER_BOARD*ID_BOARD_RGB)
#define LVM_FACE_1_B				(8+PINS_PER_BOARD*ID_BOARD_RGB)
...
#define LVM_FACE_2_R				(7+PINS_PER_BOARD*ID_BOARD_RGB)
#define LVM_FACE_2_G				(6+PINS_PER_BOARD*ID_BOARD_RGB)
...
#define LVM_FACE_3_R				(4+PINS_PER_BOARD*ID_BOARD_RGB)
#define LVM_FACE_3_G				(3+PINS_PER_BOARD*ID_BOARD_RGB)
#define LVM_FACE_3_B				(2+PINS_PER_BOARD*ID_BOARD_RGB)
...
#define LVM_FACE_4_R				(45+PINS_PER_BOARD*ID_BOARD_RGB)
#define LVM_FACE_4_G				(44+PINS_PER_BOARD*ID_BOARD_RGB)
#define LVM_FACE_4_B				(46+PINS_PER_BOARD*ID_BOARD_RGB)
